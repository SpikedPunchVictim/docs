...
* [openAUTH](https://openauth.js.org/): Self hosted auth service that is scalable, has UI, provides hooks for user management, and provides a customizable UI that can also be embedded.
